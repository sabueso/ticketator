# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2017-02-01 18:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rssfeed', models.CharField(blank=True, max_length=400, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file_name', models.FileField(blank=True, null=True, upload_to=core.models.get_attachment_upload_path)),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
