...
urlpatterns = [
    ...
    url(r'^settings/user/(?P<user_id>\d+)?$',
        vusers.manage_user, name='user-edit'),
    url(r'^settings/user/delete/(?P<user_id>\d+)?$',
        vusers.delete_user, name='user-delete'),
    ...
    url(r'^settings/groups/(?P<group_id>\d+)?$',
        vgroup.manage_group, name='group-edit'),
    ...
    url(r'^settings/rights/(?P<right_id>\d+)?$',
        vright.manage_right, name='right-edit'),
    ...
    url(r'^settings/state/delete/(?P<state_id>\d+)?$',
        vstates.delete_state, name='state-delete'),
    url(r'^settings/state/(?P<state_id>\d+)?$',
        vstates.manage_state, name='state-edit'),

    # Companys
    url(r'^settings/companies/$', vcompanies.list_companies, name='company-list'),
    url(r'^settings/companies/create',
        vcompanies.manage_company, name='company-create'),
    ...
    url(r'^settings/priorities/create',
        vpriorities.manage_priority, name='priority-create'),
    ...
    url(r'^settings/queue/delete/(?P<queue_id>\d+)?$',
        vqueues.delete_queue, name='queue-delete'),
    url(r'^settings/queue/(?P<queue_id>\d+)?$',
        vqueues.manage_queue, name='queues-edit'),

    # Tickets
    url(r'^tickets/(?P<assigned_state>\d+)?$$',
        vtickets.list_tickets, name='tickets-list'),
    url(r'^tickets/create', vtickets.manage_ticket, name='tickets-create'),
    url(r'^tickets/edit/(?P<ticket_id>\d+)?$',
        vtickets.manage_ticket, name='tickets-edit'),
    url(r'^tickets/view/(?P<ticket_id>\d+)?$',
        vtickets.view_ticket, name='view_ticket'),

    url(r'^tickets/delete/(?P<ticket_id>\d+)?$',
        vtickets.delete_ticket, name='tickets-delete'),
    # Listing tickets
    # url(r'^tickets/list/?/?$', vtickets.list_tickets, name='tickets-list-state'),
    # Filtering states
    url(r'^tickets/state/(?P<state_id>\d+)?$',
        vtickets.list_tickets, name='tickets-list-state'),
    # Filtering queues
    url(r'^tickets/queue/(?P<queue_id>\d+)?$',
        vtickets.list_tickets, name='tickets-list-state'),
    # Comments post
    ...
    url(r'^tickets/del_comment/$', vtickets.del_comment_jx,
        name='tickets-del-comment'),
    # Post percentage
    ...
    url(r'^tickets/del_microtask/$', vtickets.del_microtask_jx,
        name='tickets-del-microtasks'),
